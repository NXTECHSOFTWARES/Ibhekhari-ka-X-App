...
class CommonPageHeader extends StatelessWidget {
  ...
  const CommonPageHeader({super.key, required this.pageTitle, required this.pageSubTitle, this.addViewModel, this.addNavPage});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
           ...
           * Page subheader
           */
          SubHeaderTextStyle(text: pageSubTitle)
        ],
      ),
    );
  }
