...
//                         viewModel.filterRecordsByMonths(month);
//                         return Column(
//                           children: [
//                             /**
//                              * Months Header Summary
//                              */
//                             Padding(
...
//                                     children: [
//                                       ReusableTextWidget(
//                                         text: "${viewModel.calculateTotalMonthBakedGood(month)}",
...
//                                       ),
//                                       ReusableTextWidget(
//                                         text: viewModel.getMostBakedPastry(month),
//                                         color: const Color(0xff56452D),
//                                         size: sFontSize,
//                                         FW: sFontWeight,
//                                       ),
...
//                                 itemCount: viewModel.monthBakingRecords.length,
//                                 itemBuilder: (context, index) {
//                                   final String bakingRecordDate = viewModel.monthBakingRecords[index].keys.first;
//                                   final bakingDate = DateFormat("dd MMMM yyyy").format(DateTime.parse(bakingRecordDate));
//                                   return Column(
//                                     crossAxisAlignment: CrossAxisAlignment.start,
//                                     children: [
//                                       ReusableTextWidget(text: bakingDate, color: iconColor, size: lFontSize),
//                                       SizedBox(
//                                         height: 10.h,
//                                       ),
//                                       ListView.builder(
//                                         shrinkWrap: true,
//                                         physics: const NeverScrollableScrollPhysics(),
//                                         itemCount: viewModel.monthBakingRecords[index].values.first.length,
//                                         itemBuilder: (BuildContext context, int i) {
//                                           final BakingRecord bakingRecord = viewModel.monthBakingRecords[index].values.first[i];
//                                           return Slidable(
